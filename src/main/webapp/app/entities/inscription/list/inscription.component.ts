...
import { EntityArrayResponseType, InscriptionService } from '../service/inscription.service';
...
export class InscriptionComponent implements OnInit {
  ...
  trackId = (_index: number, item: IInscription): number => this.inscriptionService.getInscriptionIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.inscriptions = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IInscription[] | null): IInscription[] {
    return data ?? [];
  }
