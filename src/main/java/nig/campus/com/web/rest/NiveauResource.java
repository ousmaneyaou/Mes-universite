...
import nig.campus.com.service.NiveauService;
...
/**
 * REST controller for managing {@link nig.campus.com.domain.Niveau}.
 */
@RestController
@RequestMapping("/api")
public class NiveauResource {
    ...
    public ResponseEntity<Niveau> updateNiveau(@PathVariable(value = "id", required = false) final Long id, @RequestBody Niveau niveau)
        ...
        Niveau result = niveauService.update(niveau);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<Niveau> partialUpdateNiveau(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, niveau.getId().toString())
        );
    }
