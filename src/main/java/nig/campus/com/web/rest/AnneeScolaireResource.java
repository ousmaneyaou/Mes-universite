...
import nig.campus.com.service.AnneeScolaireService;
...
/**
 * REST controller for managing {@link nig.campus.com.domain.AnneeScolaire}.
 */
@RestController
@RequestMapping("/api")
public class AnneeScolaireResource {
    ...
    public AnneeScolaireResource(AnneeScolaireService anneeScolaireService, AnneeScolaireRepository anneeScolaireRepository) {
    ...
    public ResponseEntity<AnneeScolaire> updateAnneeScolaire(
        ...
        AnneeScolaire result = anneeScolaireService.update(anneeScolaire);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<AnneeScolaire> partialUpdateAnneeScolaire(
        ...
        Optional<AnneeScolaire> result = anneeScolaireService.partialUpdate(anneeScolaire);
