...
import nig.campus.com.service.UniversiteService;
...
/**
 * REST controller for managing {@link nig.campus.com.domain.Universite}.
 */
@RestController
@RequestMapping("/api")
public class UniversiteResource {
    ...
    public ResponseEntity<Universite> createUniversite(@RequestBody Universite universite) throws URISyntaxException {
        ...
        Universite result = universiteService.save(universite);
    ...
    public ResponseEntity<Universite> updateUniversite(
        ...
        Universite result = universiteService.update(universite);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<Universite> partialUpdateUniversite(
        ...
        Optional<Universite> result = universiteService.partialUpdate(universite);
    ...
    public ResponseEntity<List<Universite>> getAllUniversites(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        ...
        Page<Universite> page = universiteService.findAll(pageable);
    ...
    public ResponseEntity<Universite> getUniversite(@PathVariable Long id) {
        ...
        Optional<Universite> universite = universiteService.findOne(id);
