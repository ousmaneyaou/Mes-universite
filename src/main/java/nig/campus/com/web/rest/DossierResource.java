...
import nig.campus.com.service.DossierService;
...
/**
 * REST controller for managing {@link nig.campus.com.domain.Dossier}.
 */
@RestController
@RequestMapping("/api")
public class DossierResource {
     ...
     */
    @GetMapping("/dossiers")
    public ResponseEntity<List<Dossier>> getAllDossiers(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
