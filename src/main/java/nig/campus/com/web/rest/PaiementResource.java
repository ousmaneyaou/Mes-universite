...
import nig.campus.com.service.PaiementService;
...
/**
 * REST controller for managing {@link nig.campus.com.domain.Paiement}.
 */
@RestController
@RequestMapping("/api")
public class PaiementResource {
    ...
    public ResponseEntity<Paiement> updatePaiement(
        ...
        Paiement result = paiementService.update(paiement);
        return ResponseEntity
            .ok()
