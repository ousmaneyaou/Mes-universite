...
import nig.campus.com.service.CampagneService;
...
/**
 * REST controller for managing {@link nig.campus.com.domain.Campagne}.
 */
@RestController
@RequestMapping("/api")
public class CampagneResource {
    ...
    public ResponseEntity<Campagne> updateCampagne(
        ...
        Campagne result = campagneService.update(campagne);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<Campagne> partialUpdateCampagne(
        ...
        Optional<Campagne> result = campagneService.partialUpdate(campagne);
