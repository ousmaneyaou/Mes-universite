...
class PaiementResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_DATE_PAIE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATE_PAIE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
