...
class SessionResourceIT {
    ...
    public static Session createEntity(EntityManager em) {
        Session session = new Session().intitule(DEFAULT_INTITULE).dateDebut(DEFAULT_DATE_DEBUT).dateFin(DEFAULT_DATE_FIN);
        return session;
    }
    ...
    public static Session createUpdatedEntity(EntityManager em) {
        Session session = new Session().intitule(UPDATED_INTITULE).dateDebut(UPDATED_DATE_DEBUT).dateFin(UPDATED_DATE_FIN);
        return session;
    }
    ...
    void createSession() throws Exception {
        ...
        assertThat(testSession.getIntitule()).isEqualTo(DEFAULT_INTITULE);
    ...
    void putExistingSession() throws Exception {
        ...
        updatedSession.intitule(UPDATED_INTITULE).dateDebut(UPDATED_DATE_DEBUT).dateFin(UPDATED_DATE_FIN);
        ...
        Session testSession = sessionList.get(sessionList.size() - 1);
        assertThat(testSession.getIntitule()).isEqualTo(UPDATED_INTITULE);
    ...
    void partialUpdateSessionWithPatch() throws Exception {
        ...
        partialUpdatedSession.dateDebut(UPDATED_DATE_DEBUT).dateFin(UPDATED_DATE_FIN);
    ...
    void fullUpdateSessionWithPatch() throws Exception {
        ...
        partialUpdatedSession.intitule(UPDATED_INTITULE).dateDebut(UPDATED_DATE_DEBUT).dateFin(UPDATED_DATE_FIN);
